...
cl /I C:\Python23\include %DEFINES% /O1 /FD /EHsc /MT /Fo".\Release/" /Fd".\Release/" /Yu"stdafx.h" /Fp".\Release/BalloonTip.pch" /Fo".\Release/" /Fd".\Release/" /W3 /c /TP /Yc"stdafx.h" /Fp".\Release/BalloonTip.pch" .\BalloonTip.cpp .\BalloonHelp.cpp
if not "%ERRORLEVEL%"=="0" goto END
link.exe  /OUT:"../BalloonTip.pyd" /INCREMENTAL:NO /NOLOGO /DLL /PDB:".\Release/BalloonTip.pdb" /IMPLIB:".\Release/BalloonTip.lib" /MACHINE:X86 %LIBS% /LIBPATH:C:\Python23\libs .\Release\BalloonHelp.obj .\Release\BalloonTip.obj .\Release\StdAfx.obj
if not "%ERRORLEVEL%"=="0" goto END
