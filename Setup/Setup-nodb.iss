...
Source: cvd\mirrors.dat; DestDir: {code:CommonProfileDir}\.clamwin\db; Components: ClamWin; Flags: ignoreversion comparetimestamp; Check: NoMirrorsDat
#ENDIF
...
[_ISTool]
OutputExeFilename=L:\Projects\ClamWin\Setup\Output\mysetup.exe
[Components]
